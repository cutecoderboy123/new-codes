%% Squat Jump (SJ) Analysis - Trial 1
...
disp('Starting SJ Trial 1 analysis...');
...
opts_traj = detectImportOptions('Group 3 S SJ 02 Trial 1  trajectories.csv', 'NumHeaderLines', 5);
traj = readmatrix('Group 3 S SJ 02 Trial 1  trajectories.csv', opts_traj);

% Now get the force plate data
opts_force = detectImportOptions('Group 3 S SJ 02 Trial 1 force.csv', 'NumHeaderLines', 5);
force = readmatrix('Group 3 S SJ 02 Trial 1 force.csv', opts_force);
